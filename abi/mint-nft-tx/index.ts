...
import { NUMB_CHAIN_COST } from "../constants";
import type { TransactionRequest } from "@ethersproject/abstract-provider";
import Web3 from "web3";

const infuraUrl = NUMB_CHAIN_COST.rpcUrl;
...
export const sendTxMintNft = async (
  ...
  const signedTx = await web3.eth.accounts.signTransaction(txData, fromWallet.privateKey);
